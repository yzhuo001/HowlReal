                ...
                builder2.setTitle("Removing this news")
                        ...
                        .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                BlacklistedNews blacklistedNews = new BlacklistedNews(news.getNewsId());
                                Log.e(TAG, "news: " + news.getNewsId());
                                blacklistedNews.setNewsID(news.getNewsId());
                                blacklistedNews.addToDatabase();
